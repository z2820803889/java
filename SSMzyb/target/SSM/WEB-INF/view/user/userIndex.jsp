...
<script>
    ...
    function exportExcel() {
        location.href="<%=request.getContextPath()%>/user/exportExcel.do";
    }
</script>
</head>
<body>
                    ...
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="startCreateTime" placeholder="请输入创建时间">
                                </div>
                                <div  style="padding:5px 0px 0px 0px;float: left;margin-right: 10px">
                                    <p>-----</p>
                                </div>
                                <div class="col-sm-2" style="margin:0;padding: 0">
                                    <input type="text" class="form-control" id="endCreateTime" placeholder="请输入创建时间">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button type="button" onclick="jump(1)" class="btn btn-default">查询</button>
                                </div>
                            </div>
                        </form>

                        <div style="border-bottom: 1px solid #ccc;margin-bottom: 10px" class="col-lg-12"></div>
                            <input class="btn btn-primary" type="button" value="导出Excel" onclick="exportExcel()"/>
                            <br/><br/>
...
<script>
    $("#uploadfile").fileinput({
        ...
        uploadUrl:"<%=request.getContextPath()%>/user/importExcel.do", //上传的地址
